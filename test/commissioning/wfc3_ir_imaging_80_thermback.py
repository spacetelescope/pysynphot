...
class thermbackCase3(thermbackCase):
    def setUp(self):
        ...
        self.setglobal(__file__)
        self.runpy()
class thermbackCase4(thermbackCase):
    def setUp(self):
        self.obsmode="wfc3,ir,f105w"
        self.spectrum="None"
        self.setglobal(__file__)
        self.runpy()
class thermbackCase5(thermbackCase):
    def setUp(self):
        self.obsmode="wfc3,ir,f110w"
        self.spectrum="None"
        self.setglobal(__file__)
        self.runpy()
class thermbackCase6(thermbackCase):
    def setUp(self):
        self.obsmode="wfc3,ir,f125w"
        self.spectrum="None"
        self.setglobal(__file__)
        self.runpy()
class thermbackCase7(thermbackCase):
    def setUp(self):
        self.obsmode="wfc3,ir,f126n"
        self.spectrum="None"
        self.setglobal(__file__)
        self.runpy()
class thermbackCase8(thermbackCase):
    def setUp(self):
        self.obsmode="wfc3,ir,f127m"
        self.spectrum="None"
        self.setglobal(__file__)
        self.runpy()
class thermbackCase9(thermbackCase):
    def setUp(self):
        self.obsmode="wfc3,ir,f128n"
        self.spectrum="None"
        self.setglobal(__file__)
        self.runpy()
class thermbackCase10(thermbackCase):
    def setUp(self):
        self.obsmode="wfc3,ir,f130n"
        self.spectrum="None"
        self.setglobal(__file__)
        self.runpy()
class thermbackCase11(thermbackCase):
    def setUp(self):
        self.obsmode="wfc3,ir,f132n"
        self.spectrum="None"
        self.setglobal(__file__)
        self.runpy()
class thermbackCase12(thermbackCase):
    def setUp(self):
        self.obsmode="wfc3,ir,f139m"
        self.spectrum="None"
        self.setglobal(__file__)
        self.runpy()
class thermbackCase13(thermbackCase):
    def setUp(self):
        self.obsmode="wfc3,ir,f153m"
        self.spectrum="None"
        self.setglobal(__file__)
        self.runpy()
class thermbackCase14(thermbackCase):
    def setUp(self):
        self.obsmode="wfc3,ir,f160w"
        self.spectrum="None"
        self.setglobal(__file__)
        self.runpy()
class thermbackCase15(thermbackCase):
    def setUp(self):
        self.obsmode="wfc3,ir,f164n"
        self.spectrum="None"
        self.setglobal(__file__)
        self.runpy()
class thermbackCase16(thermbackCase):
    def setUp(self):
