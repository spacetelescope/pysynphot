...
+============================+==============================+====================================================+
|Master tables               | $PYSYN_CDBS/mtab/            |All directories in this table are included in       |
+----------------------------+------------------------------+ftp://ftp.stsci.edu/cdbs/tarfiles/synphot1.tar.gz   +
...
| Description                              | Directory name             | Download                                        |
+==========================================+============================+=================================================+
|AGN templates                             |$PYSYN_CDBS/grid/agn/       |These directories are included in                |
+------------------------------------------+----------------------------+ftp://ftp.stsci.edu/cdbs/tarfiles/synphot2.tar.gz|
